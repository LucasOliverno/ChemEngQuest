// Weekly schedule starting 26/03/2026. Each week has tasks from both roadmaps.
// Tags: INT = Roadmap Internacional, CON = Consultoria BH
...
const WEEKLY_SCHEDULE = [
  ...
  { week: 52, tasks: ['t5_6', 't5_7'] },
  { week: 53, tasks: ['t6_1'] },
  { week: 54, tasks: ['t6_2'] },
  { week: 55, tasks: ['t6_3'] },
  { week: 56, tasks: ['t6_3', 't6_4'] },
  { week: 57, tasks: ['t6_4', 't6_5'] },
  { week: 58, tasks: ['t6_6', 't6_7'] },
];
